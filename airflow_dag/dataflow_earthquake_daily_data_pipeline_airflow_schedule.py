...
t1_extract_data_api_and_write_gcs_daily = BeamRunPythonPipelineOperator(
    task_id="p1_extract_data_api_and_write_gcs_daily",
    dag=dag,
    gcp_conn_id="gcp_connection",
    runner=BeamRunnerType.DataflowRunner,
    py_file="gs://earthquake_analysis_buck/dataflow/dataflow_code/p1_extract_data_api_and_write_gcs_daily.py",

)


t2_read_from_landing_apply_trans_load_silver = BeamRunPythonPipelineOperator(
    task_id="t2_read_from_landing_apply_trans_load_silver_daily",
    dag=dag,
    gcp_conn_id="gcp_connection",
    runner=BeamRunnerType.DataflowRunner,
...
t3_read_silver_load_bq_golden = BeamRunPythonPipelineOperator(
    task_id="p3_read_silver_load_bq_golden_daily",
    dag=dag,
    gcp_conn_id="gcp_connection",
    runner=BeamRunnerType.DataflowRunner,
...
start >> t1_extract_data_api_and_write_gcs_daily >> t2_read_from_landing_apply_trans_load_silver>>t3_read_silver_load_bq_golden>> end

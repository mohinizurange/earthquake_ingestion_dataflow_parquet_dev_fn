...
# Define custom pipeline options for runtime parameters
class MyPipelineOptions(PipelineOptions):
    @classmethod
    def _add_argparse_args(cls, parser):
        parser.add_value_provider_argument('--api_url', type=str, help='Path to input file')
        parser.add_value_provider_argument('--pipeline_nm', type=str, help='Path to output file')

if __name__ == '__main__':
    pipeline_options = PipelineOptions()
    my_options = pipeline_options.view_as(MyPipelineOptions)

    api_url = my_options.api_url
    pipeline_nm = my_options.pipeline_nm
    os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = r"D:\Mohini Data Science\earthquake_ingestion_dataflow_dev\archive\ascendant-nova-439815-t2-6475a0e6cbd5.json"
...
"""
 python "D:/Mohini Data Science/earthquake_ingestion_dataflow_dev/archive/dataflow_earthquake_template.py" --runner DataflowRunner --project ascendant-nova-439815-t2 --region us-central1 --staging_location gs://earthquake_analysis_buck/stagging_loc --temp_location gs://earthquake_analysis_buck/temp_loc --template_location gs://earthquake_analysis_buck/templates/earth_quak2

gcloud dataflow jobs run p1 --gcs-location gs://earthquake_analysis_buck/templates/earth_quak2 --parameters api_url="https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_month.geojson",pipeline_nm='daily'
